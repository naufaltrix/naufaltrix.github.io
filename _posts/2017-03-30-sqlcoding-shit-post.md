...
```sql
SELECT users.username,users.email,user_profiles.userId as userId_sales,user_profiles.name as user_name,user_profiles.phone,
...
WHERE users.banned = 0 AND users.activated = 1 AND user_profiles.referenceId = 36003607412310586
